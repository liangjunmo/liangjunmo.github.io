...
## [vim-nerdtree-tabs](https://github.com/jistr/vim-nerdtree-tabs) and [nerdtree-git-plugin](https://github.com/Xuyuanp/nerdtree-git-plugin)

我用 vim-nerdtree-tabs 主要是用来配置当切换标签页的时候默认移动到文件中，而不是 NERDTree。
